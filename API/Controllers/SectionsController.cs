...
namespace DoubleMAPI.Controllers
{
    ...
    public class SectionsController : ControllerBase
    {
        ...
        public SectionsController(ISectionService sectionService)
        {
            ...
            _logger = Log.ForContext<SectionsController>();
        }
        ...
        public async Task<ActionResult<SectionDto>> CreateSection(int courseId, [FromBody] CreateSectionDto dto)
        {
            ...
            try
            {
                var sectionId = await _sectionService.CreateSectionAsync(courseId, dto.Title, dto.DisplayOrder);
                ...
                return CreatedAtAction(nameof(GetSectionById), new { courseId, sectionId },
                    new { success = true, data = section });
            }
            catch (Exception ex)
            {
                _logger.Error(ex, "Error creating section for course {CourseId}", courseId);
